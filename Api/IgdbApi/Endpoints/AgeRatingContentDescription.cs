...
{
    public static class AgeRatingContentDescription
    {
        public static string Endpoint = "age_rating_content_descriptions";

        public record AgeRatingContentDescriptionJson(
            int id,
            Category? category,
            Guid? checksum,
            string? description
